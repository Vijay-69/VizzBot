...
const formSchema = z.object({
  ...
  seed: z.string().min(200, {
    message: "Seed require at least 250 characters .",
  }),
  src: z.string().min(1, {
 ...
 const router = useRouter();
  ...
  return (
    <div className="h-full p-4 space-y-2 max-w-3xl mx-auto">
      { /*...form is shortcut to pass all props to Form */}
      <Form {...form}>
          ...
          <div className="space-y-2 w-full">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                (General information about your Custom AI Model)
              </p>
            </div>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Describe in detail your Avatar&apos;s backstory and relevant details.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
